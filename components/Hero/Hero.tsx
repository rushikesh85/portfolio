...
import { TextGenerateEffect } from '../ui/TextGenaratorEffect'
        ...
        <div className='pb-20 pt-36'>
            ...
            <div className='flex justify-center relative my-20 z-10'>
                <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                    {/* <h2 className='uppercase tracking-widest text-xs text-center text-blue-100 max-w-80'>dynamic portfolio for better </h2> */}
                    <TextGenerateEffect
